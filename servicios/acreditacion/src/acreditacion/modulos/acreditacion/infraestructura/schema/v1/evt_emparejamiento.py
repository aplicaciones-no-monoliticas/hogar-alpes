"""Copia de `contratos/v1/evt_emparejamiento.py` (CON-1) — Acreditación solo
CONSUME `proveedor-propuesto` para confirmar/rechazar vigencia (ver
`specs/002-saga-asignacion-trabajo/research.md` D2, D4, D6).
