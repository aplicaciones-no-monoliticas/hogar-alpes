"""Copia de `contratos/v1/evt_acreditacion.py` (CON-1). La fuente de verdad es
el registro de esquemas del broker; esta copia existe para que este servicio no
dependa en tiempo de compilación de un paquete compartido (`TO-7`).
