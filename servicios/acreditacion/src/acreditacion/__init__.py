...
def _registrar_modelos():
    ...
    from .modulos.acreditacion.infraestructura.dto import Base as BaseAcreditacion
    return [BaseAcreditacion]
...
def _registrar_handlers():
    ...
    import acreditacion.modulos.acreditacion.aplicacion.queries.obtener_eventos_acreditacion  # noqa: F401


def _registrar_rutas(app):
    """PUNTO DE EXTENSIÓN 3 — registrar los blueprints del servicio."""
    from .api.acreditaciones import bp as bp_acreditaciones
    app.register_blueprint(bp_acreditaciones)
