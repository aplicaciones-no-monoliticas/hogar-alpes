"""Copia de `contratos/v1/evt_emparejamiento.py` (CON-1) — Gestión de Trabajos
solo CONSUME este contrato: escucha `sin-candidatos` para compensar la saga
(ver `specs/002-saga-asignacion-trabajo/research.md` D2, D6).

Stream `evt-emparejamiento` — resultado del emparejamiento. Clave de
partición: `trabajo_id`.
"""
