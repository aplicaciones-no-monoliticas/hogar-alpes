"""Copia de `contratos/v1/evt_acreditacion.py` (CON-1) — Gestión de Trabajos
solo CONSUME los tipos de saga (`vigencia-confirmada`/`vigencia-rechazada`),
nunca `actualizada` (ver `specs/002-saga-asignacion-trabajo/research.md` D2, D6).
