...
def main():
    """Operaciones tiene UNA sola suscripción: `operaciones`, Failover, por
    patrón `evt-trabajo-.*` (todas las regiones, §5.1 de la especificación).
    A diferencia de Emparejamiento no hay una segunda suscripción que aislar
    en su propio rol: este proceso siempre la atiende entera.
    """
    ...
    from .modulos.operaciones.infraestructura.consumidores import suscribirse
