...
def _registrar_modelos():
    ...
    from .modulos.sagas.infraestructura.dto import Base as BaseSagas
    return [BaseSagas]
...
def _registrar_handlers():
    ...
    import saga_log.modulos.sagas.aplicacion.queries.obtener_resumen  # noqa: F401
    import saga_log.modulos.sagas.aplicacion.queries.obtener_saga  # noqa: F401
    import saga_log.modulos.sagas.aplicacion.queries.obtener_sagas_por_estado  # noqa: F401


def _registrar_rutas(app):
    """PUNTO DE EXTENSIÓN 3 — registrar los blueprints del servicio."""
    from .api.sagas import bp as bp_sagas
    app.register_blueprint(bp_sagas)
